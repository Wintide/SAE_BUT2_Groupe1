...
<div id="model-consulter" class="model hidden">
    <div class="model-content">
        ...
        <!-- UNIQUEMENT moniteur -->
        <p class="field-monitor"><strong>Fabricant :</strong> <span id="model-monitormanufacturer"></span></p>
        <p class="field-monitor"><strong>Modèle :</strong> <span id="model-monitormodel"></span></p>
